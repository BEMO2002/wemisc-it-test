...
const HeadServices = () => {
  ...
  // Note: We don't set document.body.dir here anymore; it's handled in layout.js
    ...
    <div className=" relative">
      <div className="bg-third p-20  text-white relative overflow-hidden">
        ...
        <div className="flex items-center justify-center flex-col gap-6 relative z-10">
          ...
          >
            {t.has("headServices.title2")
              ? t("headServices.title2")
              : "Courses"}
          </h1>
          ...
          >
            ...
            >
              {t.has("navbar.home") ? t("navbar.home") : "Home"}
            </Link>
